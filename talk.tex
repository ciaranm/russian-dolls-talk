...
\begin{frame}{An Old Maximum Clique Algorithm}
    ...
    \only<6>{
        \begin{itemize}
            ...
            \item This fell out of fashion, for clique: dynamic variable orderings and better
...
\begin{frame}{Specialisation}
    \only<1>{
        \begin{itemize}
            \item Instead of looking at variables, we can look at variable-value pairs.
            \item This is even more expensive, but sometimes it pays off.
            \item Sometimes it's possible to do this selectively.
        \end{itemize}
    }
\end{frame}
