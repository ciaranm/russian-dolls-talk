    ...
    \only<6>{
        ...
        \begin{center}
            \begin{tikzpicture}%{{{
                ...
                \draw [color = gray] (V6) to [out = 45, in = 135] (V8);
                \draw [color = gray] (V5) to [out = 45, in = 135] (V7);
                \draw [color = gray] (V4) to [out = 45, in = 135] (V5);
                \draw [color = gray] (V4) to [out = 45, in = 135] (V7);
                \draw [color = gray] (V4) to [out = 45, in = 135] (V8);
        ...
        \begin{itemize}
            \item Seems to be good if we have a fairly well-behaved objective function, but a very
                ...
                \begin{itemize}
                    ...
                    \item DNA Analysis
                    \item Still-Life (until Chu and Stuckey solved it)
                \end{itemize}
        \end{itemize}
    }
